...
const csvUrl = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vRACVPKbZcC27WYWzpRD5XVqZ4gT0Gfvb5GYav1KyQQRqPPFKYcZraBQQjdkmzDyFFvr2rVtysxTuJH/pub?output=csv';
let quinielasData = [];
let csvHeaders = [];
Swal.fire({
